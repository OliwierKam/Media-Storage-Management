...
# https://www.youtube.com/watch?v=HM4LFJ1Ab9g

# Replace with the management group ID and other required values

resource_ids = [
    '/subscriptions/62c9b855-2fef-4672-a795-d183abee8f37/resourceGroups/test/providers/Microsoft.Storage/storageAccounts/newoliwier',
] 
...
query_scope ='/subscriptions/62c9b855-2fef-4672-a795-d183abee8f37'
day_of_month = 4
